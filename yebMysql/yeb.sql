...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES (1, '系统管理员', '13812361398', '71937538', '香港特别行政区强县长寿柳州路p座123', 1, 'admin', '$2a$10$ddASQuXKQ/Vq6OE0WlH1x.faLRHJOaJfxcLyl1WDWwWJUb9tydA1C', 'https://typora001-zc.oss-cn-chengdu.aliyuncs.com/typoraImg/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20201129110005.jpg', NULL);
INSERT INTO `t_admin` VALUES (2, '何淑芬', '18875971675', '41413109', '河北省秀荣市萧山长沙街p座 737268', 1, 'taomeng', '$2a$10$ddASQuXKQ/Vq6OE0WlH1x.faLRHJOaJfxcLyl1WDWwWJUb9tydA1C', 'https://typora001-zc.oss-cn-chengdu.aliyuncs.com/typoraImg/5a2ca5d0cd8ea91e12add61a9dc71b61.jpg', NULL);
INSERT INTO `t_admin` VALUES (3, '安淑华123', '14588110811', '50603155', '山东省凤英县长寿银川街l座', 1, 'naqiao', '$2a$10$ddASQuXKQ/Vq6OE0WlH1x.faLRHJOaJfxcLyl1WDWwWJUb9tydA1C', 'https://typora001-zc.oss-cn-chengdu.aliyuncs.com/typoraImg/5a2ca5d0cd8ea91e12add61a9dc71b61.jpg', NULL);
INSERT INTO `t_admin` VALUES (4, '林宇', '15761248727', '25546253', '宁夏回族自治区帆市翔安昆明路b座 672985', 0, 'leisu', '$2a$10$ddASQuXKQ/Vq6OE0WlH1x.faLRHJOaJfxcLyl1WDWwWJUb9tydA1C', 'https://typora001-zc.oss-cn-chengdu.aliyuncs.com/typoraImg/5a2ca5d0cd8ea91e12add61a9dc71b61.jpg', NULL);
INSERT INTO `t_admin` VALUES (5, '武军', '18030710396', '27523842', '宁夏回族自治区秀兰县涪城邯郸路t座 618651', 0, 'hanli', '$2a$10$ddASQuXKQ/Vq6OE0WlH1x.faLRHJOaJfxcLyl1WDWwWJUb9tydA1C', 'https://typora001-zc.oss-cn-chengdu.aliyuncs.com/typoraImg/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20201129110005.jpg', NULL);
...
INSERT INTO `t_admin_role` VALUES (83, 2, 3);
INSERT INTO `t_admin_role` VALUES (84, 2, 4);
...
CREATE TABLE `t_department`  (
  ...
  `depPath` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '路径',
  `enabled` tinyint(1) NULL DEFAULT 1 COMMENT '是否启用',
...
) ENGINE = InnoDB AUTO_INCREMENT = 931 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_joblevel`  (
  ...
  `titleLevel` enum('正高级','副高级','中级','初级','员级','高级') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '职称等级',
...
CREATE TABLE `t_mail_log`  (
  `msgId` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '消息id',
  `eid` int NULL DEFAULT NULL COMMENT '接收员工id',
  `status` int NULL DEFAULT NULL COMMENT '状态（0:消息投递中 1:投递成功 2:投递失败）',
  `routeKey` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '路由键',
  `exchange` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交换机',
...
-- ----------------------------
INSERT INTO `t_mail_log` VALUES ('123456', 827, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-22 00:00:23', '2023-01-21 23:59:23', '2023-01-21 23:59:23');
INSERT INTO `t_mail_log` VALUES ('4535224a-c452-4eb6-8c01-f9fa321aada8', 829, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-23 02:23:48', '2023-01-23 02:22:48', '2023-01-23 02:22:48');
INSERT INTO `t_mail_log` VALUES ('49b04003-06c5-4a4f-b825-81b19bdece74', 828, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-23 02:22:16', '2023-01-23 02:21:16', '2023-01-23 02:21:16');
INSERT INTO `t_mail_log` VALUES ('8fb23741-125f-4d14-8ab0-4374f062fa6e', 825, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-21 02:15:46', '2023-01-21 02:14:46', '2023-01-21 02:14:46');
INSERT INTO `t_mail_log` VALUES ('a5f8eee6-a437-4a1a-b873-b7b810dccdd2', 824, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-21 02:09:37', '2023-01-21 02:08:37', '2023-01-21 02:08:37');
INSERT INTO `t_mail_log` VALUES ('ca6b9f19-5b7f-4c09-bb51-5a5f4c60d873', 830, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-27 15:24:41', '2023-01-27 15:23:41', '2023-01-27 15:23:41');
...
INSERT INTO `t_menu` VALUES (24, '/system/cfg/**', '/sys/cfg', 'SysConfig', '系统管理', NULL, NULL, 1, 6, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 769 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_menu_role` VALUES (766, 7, 4);
INSERT INTO `t_menu_role` VALUES (767, 8, 4);
INSERT INTO `t_menu_role` VALUES (768, 11, 4);
...
CREATE TABLE `t_nation`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '民族',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_politics_status`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '政治面貌',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `t_salary` VALUES (2, 6000, 500, 500, 500, NULL, 1800, 0.06, '2018-01-01 00:00:00', 2200, 0.06, 3200, 0.06, '人事部工资账套');
